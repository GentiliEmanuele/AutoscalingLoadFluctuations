...
public class SystemStats {
    ...
    public SystemStats(double throughput, double meanUtilization, double meanBusyServer, double meanServiceTime, double meanResponseTime, int totalCompletion, double totalBusyTime) {
