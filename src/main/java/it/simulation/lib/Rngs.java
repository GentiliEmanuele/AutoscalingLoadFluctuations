 ...
 * selectStream(state) to switch between streams indexed state = 0,1,...,255.
 *
...
public class Rngs {
    ...
    // Consistent with the changes to the it.uniroma2.libs.others.Rvgs constructor, the seed[] array and
...
//  static int  initialized   = 0;          /* test for stream initialization */
    ...
    public Rngs () {
        ...
        // (see comments in it.uniroma2.libs.others.Rvgs.java)
        seed[0] = DEFAULT;
        /* Barry Lawson 8 Nov 2007 */
    }
