 ...
 * density functions (pdf'state), cumulative distribution functions (cdf'state), and
 * inverse distribution functions (idf'state) for a variety of discrete and
 * continuous random variables.
 *
 * The following notational conventions are used
 *                 x : possible value of the random variable
 *                 u : real variable (probability) between 0.0 and 1.0
 *  a, b, n, p, m, state : distribution-specific parameters
 *
 * There are pdf'state, cdf'state and idf'state for 6 discrete random variables
 *
 ...
 *      normal(m, state)       all x      m            state*state
...
public class Rvms {
    ...
    public double pdfNormal(double m, double s, double x)
        /* ==============================================
         * NOTE: x and m can be any value, but state > 0.0
         * ==============================================
         */
    {
        double t = (x - m) / s;
    ...
    public double idfNormal(double m, double s, double u)
        /* =======================================================
         * NOTE: m can be any value, but state > 0.0 and 0.0 < u < 1.0
         * =======================================================
         */
    {
