...
public class TransitoryAdvancedConfigurations extends Config {
    public static void setTransitoryAdvancedConfiguration(String indicatorType, double autoScalingThr) {
        SEED = 42;
        ARRIVALS_MU = 0.15;
        ARRIVALS_CV = 4;
        SERVICES_Z = 0.16;
        ...
        ARRIVALS_FAST_MU = 0.15 / 1.2; // fast lambda = 8 req/sec
