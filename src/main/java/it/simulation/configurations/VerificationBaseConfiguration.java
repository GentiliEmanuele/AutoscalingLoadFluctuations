...
public class VerificationBaseConfiguration extends Config {
    public static void setVerificationBaseConfiguration() {
        SEED = 42;
        ARRIVALS_MU = 0; // It's a don't care because it's set after
        ARRIVALS_CV = 4;
        SERVICES_Z = 1;
        SERVICES_CV = 4;
        ...
        SPIKE_CAPACITY = 1;
        SI_MAX = 1; // It's a don't care because spike server is not active
