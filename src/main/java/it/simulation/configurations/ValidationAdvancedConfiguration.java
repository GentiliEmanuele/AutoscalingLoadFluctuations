...
public class ValidationAdvancedConfiguration extends Config {
    public static void setValidationAdvancedConfiguration() {
        SEED = 42;
        ARRIVALS_MU = 0.15;
        ARRIVALS_CV = 4;
        SERVICES_Z = 0.16;
        ...
        ARRIVALS_FAST_MU = 1 / (2 * (1 / 0.15)); // fast lambda is the double of mean lambda
        REPETITION_NUMBER = 1;
        ...
        TURN_ON_MU = 5;
        TURN_ON_STD = 0.5;
        SCALING_INDICATOR_TYPE = "r0";
        SCALING_OUT_THRESHOLD = 3;
